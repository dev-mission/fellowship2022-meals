...
router.get('/', async (req, res) => {
  const allPartner = await models.NutritionPartner.findAll();
  res.json(allPartner.map((r) => r.toJSON()));
});

router.get('/:id', async (req, res) => {
  const partner = await models.NutritionPartner.findByPk(req.params.id);
  if (partner) {
